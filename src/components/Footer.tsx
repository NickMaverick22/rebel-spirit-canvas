...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 py-16 md:py-24">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-none font-inter text-gray-900 placeholder-gray-500 focus:outline-none focus:border-rebellious-red transition-colors duration-300"
                  required
                />
                <button
                  type="submit"
